package com.flexath.resources.java.theme

import androidx.compose.ui.graphics.Color

val colorPrimary = Color(0xFF2274E0)
val colorOnPrimary = Color(0xFFFFFCFE)
...
val starColor = Color(0xFFFFC120)
val variantSelectedBackgroundColor = Color(0xFFEFF5FB)